...
- Create Angular project with ng: `ng new crudclientesprodutos.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`crudclientesprodutos.client.esproj`).
